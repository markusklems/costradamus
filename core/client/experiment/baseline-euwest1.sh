...
node mainBatch.js -i experiment/baseline-euwest1-ingestValue.txt
node mainBatch.js -i experiment/baseline-euwest1-readPredictions.txt
node mainBatch.js -i experiment/baseline-euwest1-readNotifications.txt
node mainBatch.js -i experiment/baseline-euwest1-readValues.txt
